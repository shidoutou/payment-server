...
public class PaymentJob   {
   ...
   **/
  @Schema(description = "A list of payment methods (for example iDeal, PayPal, AfterPay) to enable for this request.  If none are supplied, all configured and applicable payment methods will be used.")
      @Valid
   ...
   * @return displayUrl
   **/
  @Schema(description = "A URL that is shown in the portal to the receiver.  This can be used to store a link to an order in the receiver's order system for easy navigation.")
   ...
   **/
  @Schema(description = "The amount collected in this payment job so far.  Only set after a payment is final (reversals such as chargebacks aside), for instance after a card capture.")
   ...
   * @return paidAmount
   **/
  @Schema(description = "The amount that the payer has has paid, which includes surcharge amounts.  Only set after a payment is final (reversals such as chargebacks aside), for instance after a card capture.")
   ...
   * @return flags
   **/
  @Schema(description = "Flags that apply to this payment job.  They can either not be set or set with a true or false value. Key options: PaymentAbandonmentEmailSent, PaidByPaymentAbandonmentEmail, Moto, ApplePay, ForcedMoto, RecurringParent, Direct, GenerateToken, StoreCardDetails, CreatedOnMapi, Frictionless")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.reference, paymentJob.reference) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(reference, createDateTimeUtc, type, traceReference, configurationId, domain, locale, timeZone, order, orderHistory, parentPaymentJobReference, paymentMethodsToUse, displayUrl, currency, amountToCollect, amountCollected, paidAmount, paidDateTimeUtc, expirationDateTimeUtc, dueDateTimeUtc, lastUpdateTimeUtc, lastProcessedTimeUtc, flags, attributes, paymentStatus, payments, recurrenceCriteria);
  }
