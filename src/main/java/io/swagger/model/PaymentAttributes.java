...
public class PaymentAttributes   {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.originatingIpAddress, paymentAttributes.originatingIpAddress) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(originatingIpAddress, originHeader, userAgent, returnUrlSuccess, returnUrlFailed, returnUrlCancelled, simulatedStatus, idealBic, paymentMethodTransactionId, paymentMethodVoidTransactionId, token, cashFlowsAcquiringDetails, descriptor, ewalletType);
  }
