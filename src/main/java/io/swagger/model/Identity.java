 ...
 */
@Schema(description = "An object containing information, additional to the address object, such as an email address, gender, and government numbers.")
@Validated
...
public class Identity   {
   ...
   * @return debtorId
   **/
  @Schema(description = "A reference, unique to the company, to the person this object relates to.  This reference is supplied by the merchant.")
   ...
   **/
  @Schema(description = "A number, unique to the specified country, identifying the person this object relates to.  This property can for example be used for a nine-digit Social Security number (SSN) for U.S citizens or a burgerservicenummer (BSN) for Dutch citizens.")
   ...
   **/
  @Schema(description = "A number, unique to the chamber of commerce of the specified country, identifying the person, organisation or company this object relates to.")
   ...
   * @return vatNumber
   **/
  @Schema(description = "A globally unique value added tax identification number of the person, organisation or company this object relates to.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.debtorId, identity.debtorId) &&
