...
public class Refund   {
   ...
   **/
  @Schema(description = "The amount to refund in the currency compatible with the selected method.  Equal to the amount to refund multiplied by the conversion rate.  If null, the amount to refund has not been converted and the amount to refund is used instead.")
   ...
   **/
  @Schema(description = "The conversion rate used for converting the amount to refund to the currency compatible with the selected method.  This rate multiplied by the amount to refund results in the converted amount to refund.  If null, the amount to refund has not been converted.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.reference, refund.reference) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(reference, createDateTimeUtc, refundNumber, status, amountToRefund, convertedAmountToRefund, convertedCurrency, conversionRate, steps, attributes);
  }
