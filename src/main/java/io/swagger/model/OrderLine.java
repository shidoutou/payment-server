...
public class OrderLine   {
   ...
   * @return url
   **/
  @Schema(description = "A URL that is shown in the portal to the receiver.  This can be used to store a link to a product for easy navigation.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(lineNumber, type, skuCode, name, description, quantity, unitPriceExclVat, unitPriceInclVat, vatPercentage, vatPercentageLabel, discountPercentageLabel, totalLineAmount, url);
  }
