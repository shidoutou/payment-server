...
public class Capture   {
   ...
   **/
  @Schema(description = "The amount to capture in the currency compatible with the selected method.  Equal to the amount to capture multiplied by the conversion rate.  If null, the amount to capture has not been converted and the amount to capture is used instead.")
   ...
   **/
  @Schema(description = "The conversion rate used for converting the amount to capture to the currency compatible with the selected method.  This rate multiplied by the amount to capture results in the converted amount to capture.  If null, the amount to capture has not been converted.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.reference, capture.reference) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(reference, createDateTimeUtc, status, amountToCapture, convertedAmountToCapture, convertedCurrency, conversionRate, isFinalCapture, attributes);
  }
