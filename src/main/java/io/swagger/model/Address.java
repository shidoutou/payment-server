...
public class Address   {
   ...
   * @return title
   **/
  @Schema(description = "A prefix or suffix added to someone's name in certain contexts.  For example \"Mr.\" or \"Ms.\"/\"Mrs.\" for an adult man or woman.  This value is used \"as is\", regardless of the locale specified in the payment job.")
   ...
   * @return middleName
   **/
  @Schema(description = "The middle part of the name of the addressee.  This is the portion of a personal name that is written between the person's given name and their surname.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, firstName, middleName, lastName, countryIso3166Alpha2, addressLine1, addressLine2, zipCode, city, stateProvince, phoneNumber1, phoneNumber1Type, phoneNumber2, phoneNumber2Type, organisation, department);
  }
