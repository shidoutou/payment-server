...
public class PaymentStep   {
   ...
   **/
  @Schema(description = "List of the payment method(s) to use.  This list will consist of multiple payment methods in case of a hosted payment, which are then reduced to exactly one payment method,  during a payment. This is done by asking the payer to make a choice in what payment method he wants to use.")
      @Valid
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.reference, paymentStep.reference) &&
