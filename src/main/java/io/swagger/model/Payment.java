...
public class Payment   {
   ...
   **/
  @Schema(description = "List of the payment method(s) to use.  This list will consist of multiple payment methods in case of a hosted payment, which are then reduced to exactly one payment method,  during a payment. This is done by asking the payer to make a choice what payment method he wants to use.")
      @Valid
   ...
   **/
  @Schema(description = "The amount to collect in this payment in the currency specified in the payment job.  If left empty the entire amountToCollect of the payment job is used upon start of the payment.")
   ...
   **/
  @Schema(description = "The total amount to be paid in this payment in the currency compatible with the selected payment method.  Equal to the amount to collect + surcharge amount, multiplied by the conversion rate.  If null, the total amount has not been converted and the amount to collect + surcharge amount is used instead.")
   ...
   **/
  @Schema(description = "The conversion rate used for converting the total amount to the currency compatible with the selected payment  method. If null, the amount to collect has not been converted.")
   ...
   * @return paidAmount
   **/
  @Schema(description = "The amount that the payer has has paid to the receiver.  Only set after a payment is final (reversals such as chargebacks aside), for instance after a card capture.")
   ...
   * @return flags
   **/
  @Schema(description = "Flags that apply to this payment.  They can either not be set or set with a true or false value. Key options: Started")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(reference, createDateTimeUtc, paymentMethods, status, lastErrorReport, abuseReport, amountToCollect, surchargeAmount, convertedTotalAmount, convertedCurrency, conversionRate, paidAmount, steps, flags, attributes, refunds, captures);
  }
